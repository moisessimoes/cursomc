...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() { //O Swagger vai acessar apenas o pacote resources e determinando as respostas que vao aparecer.
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select().apis(RequestHandlerSelectors.basePackage("com.moises.cursomc.resources"))
	...
	private ApiInfo apiInfo() { //Preenchendo as informações de cabeçalho. Essa abaixo sao do professor, mas so é atualizar depois.
	...
	private ResponseMessage customMessage1() { //Response headers personalizados
